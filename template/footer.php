                            ...
                            <div class="col-lg-3 col-sm-8 text-center text-sm-left mb-sm-0 mb-3">
                                <div class="row">
                                    ...
                                    <div class="col-12 text-justify">
                                        <p>Website untuk jual beli barang bekas untuk teman teman kosan, bisa ketemuan langsung</p>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div class="col-12">
                                        <form action="#">
                                            <div class="form-group">
                                                <input type="text" class="form-control" placeholder="Saran..." required>
                                            </div>
                                            <div class="form-group">
                                                <button class="btn btn-outline-primary text-uppercase">Kirim</button>
                                            </div>
                                        </form>
                                    </div>
                                </div>
