                    ...
                    <div class="col-12">
                        <div class="row">
                            <div class="col-12 py-3">
                                <div class="row">
                       <?php 
                                        $id_brand = $_GET['id_kategori'];
                                        $querbrand = mysqli_query ($koneksi, "select * from tbl_brand WHERE id_kategori = '$id_brand'");
                                        $hasilQuerybrand = mysqli_fetch_array($querbrand);
                                        $nama_brand =  $hasilQuerybrand['nama_kategori'];

                       ?>
                                </div>
                                <div class="row">
                                <div class="col-12 text-left text-uppercase">
                                        <h2>PRODUK <?= $nama_brand; ?></h2>
                                    </div>
                                    <?php 
        
                         $queryproduk = mysqli_query ($koneksi, "select * from tbl_produk where id_brand = '$id_brand'" );
